const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LapSchedule-Dgpp3_61.js","assets/jsx-runtime-BMWpmvRY.js","assets/clsx-ChV9xqsO.js","assets/format-D2piKjyT.js","assets/race--XsfwnTx.js","assets/StatsPanel-B0wY9dAx.js","assets/TimerDisplay-C4rQh9Vm.js","assets/TopBar-DFpLnXPP.js"])))=>i.map(i=>d[i]);
...
const _home_runner_work_frontyard_timer_frontyard_timer_src_components_LapSchedule_LapSchedule = () => __vitePreload(() => import('./LapSchedule-Dgpp3_61.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0).then((mod) => mod.LapSchedule);
const _home_runner_work_frontyard_timer_frontyard_timer_src_components_StatsPanel_StatsPanel = () => __vitePreload(() => import('./StatsPanel-B0wY9dAx.js'),true              ?__vite__mapDeps([5,1,4]):void 0).then((mod) => mod.StatsPanel);
const _home_runner_work_frontyard_timer_frontyard_timer_src_components_TimerDisplay_TimerDisplay = () => __vitePreload(() => import('./TimerDisplay-C4rQh9Vm.js'),true              ?__vite__mapDeps([6,1,2,3,4]):void 0).then((mod) => mod.TimerDisplay);
const _home_runner_work_frontyard_timer_frontyard_timer_src_components_TopBar_TopBar = () => __vitePreload(() => import('./TopBar-DFpLnXPP.js'),true              ?__vite__mapDeps([7,1,3]):void 0).then((mod) => mod.TopBar);
__pwRegistry.initialize({ _home_runner_work_frontyard_timer_frontyard_timer_src_components_LapSchedule_LapSchedule,
  _home_runner_work_frontyard_timer_frontyard_timer_src_components_StatsPanel_StatsPanel,
  _home_runner_work_frontyard_timer_frontyard_timer_src_components_TimerDisplay_TimerDisplay,
  _home_runner_work_frontyard_timer_frontyard_timer_src_components_TopBar_TopBar });

export { getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-D-C7wG_k.js.map
