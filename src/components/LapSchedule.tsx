...
import { buildLapSchedule } from "../lib/race";
...
export function LapSchedule({ config, state }: LapScheduleProps) {
	...
	return (
		<div className="flex flex-col bg-neutral-900 border-r border-neutral-800 overflow-hidden">
			<div className="px-4 py-2 bg-black border-b border-neutral-800 font-mono text-xs tracking-widest text-neutral-400 grid grid-cols-3">
